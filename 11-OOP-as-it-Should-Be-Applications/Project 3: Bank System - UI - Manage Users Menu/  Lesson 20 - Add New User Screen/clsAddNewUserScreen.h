...
private:
   ...
   /* static int _ReadPermissionsToSet()
    ...
    static int _ReadPermissionsToSet()
    {
        ...
        if (Answer == 'Y' || Answer == 'y')
        {
            Permissions = Permissions | clsUser::enPermissions::pListClients;
        }
        ...
        if (Answer == 'y' || Answer == 'Y')
        {
            Permissions = Permissions | clsUser::enPermissions::pUpdateClients;
        }
        ...
        if (Answer == 'y' || Answer == 'Y')
        {
            Permissions = Permissions | clsUser::enPermissions::pTranactions;
        }
